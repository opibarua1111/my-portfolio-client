    ...
    return (
        <div className="bg-gray-800 py-3">
            <div className="w-full grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 lg:gap-5 container">
                <div >
                    <h1 className="text-5xl pt-3 text-gray-300 bold">My Portfolio</h1>
                    <p className="text-sm pt-2 text-gray-300">My name is Opi Barua. I am a Full Stack Developer. Student of Computer Science and Engineering in BGC Trust University Bangladesh.</p>
                </div>
                <div className="">
                ...
                <div className="">
                    <div className="flex pb-2 justify-center">
                        ...
                        <div className=" text-blue-50 hover:text-blue-400 lg:mt-20 ml-5 text-2xl w-11 h-11 rounded-full bg-blue-400 hover:bg-blue-50 flex items-center justify-center"><a href="https://twitter.com/barua_opi" className="hover:text-blue-400">{twitter}</a></div>
